...
namespace Truke.Controllers
{
    ...
    public class LinksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ApplicationUserId,Datetime,Name,url")] Link link)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ApplicationUserId,Datetime,Name,url")] Link link)
        {
            if (id != link.Id)
            {
                return NotFound();
